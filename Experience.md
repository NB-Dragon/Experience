# 项目备注
> 本人承诺，以下项目均由本人完成。按不同类型进行分类，每一个类别中的具体项目从新到旧进行排序
...
- 项目开发内容
> - 采用敏捷开发的生存期模型，把任务需求进行极限分割
> - 自行设计并开发具有前后分离开发理念的网站框架，不引用其他第三方框架
> - 前端页面以HTML的形式浏览，采用原生PHP开发后台API，最后网页通过Ajax请求获取动态数据
> - 项目设置系统管理员/学校管理员/教师/学生四种角色，权限从高到低依次排列
> - 模仿百度云盘的原理，开发教师-学生的文件共享平台
> - 加入青岛大学的JudgeServer，实现作业评测的功能
